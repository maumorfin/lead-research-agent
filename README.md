...
Beyond answering questions, it works **proactively**: a background race watcher sends Telegram notifications when something important happens during a live stage — attacks, crashes, breakaways, stage wins.
...
| [`feature/proactive-agent`](../../tree/feature/proactive-agent) | Background race watcher, live notifications, self-maintaining race calendar — **merged into `main`** |
